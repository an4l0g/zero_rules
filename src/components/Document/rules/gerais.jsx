    ...
    rules: [
      {
        content: (
          <>
            Ao iniciar o processo de whitelist, você declara que está de acordo
            com todas as regras contidas neste documento e com todos os nossos{" "}
      ...
      },
      {
        content: (
          <>
            A <b>ZERO CITY</b> não assume responsabilidade por atitudes, falas
            ou opiniões de membros fora dos ambientes controlados por nós.
            Lembre-se, o respeito deve prevalecer em todas as interações, mesmo
            fora de nossas plataformas.
          </>
        ),
      },
      {
        content: (
          <>
            Os seguintes canais: Discord, Loja Virtual, WhatsApp, Instagram, Tik
            Tok e todo e qualquer meio de comunicação relacionado à{" "}
            <b>ZERO CITY</b>, são considerados extensões da cidade. Sendo assim,
            advertências e banimentos poderão ser aplicados caso algum membro
            tenha condulta divergente à esperada.
          </>
        ),
      },
      {
      ...
      },
      {
        content: (
          <>
            É <b>terminantemente proibido</b> qualquer tipo de discriminação
            seja ela por raça, sexo, cor, idade e etc.
          </>
        ),
      },
      {
        content: (
          <>
            É <b>proibido</b> utilizar das mecânicas do jogo para obter
            vantagens que em situações reais que não seriam possíveis. Alguns
            exemplos são:
          </>
        ),
        extras: [
      ...
      },
      {
        content: (
          <>
            É <b>proibido</b> reanimar pessoas desmaiadas para continuar um RP,
      ...
      },
      {
        content: (
          <>
            É <b>proibido</b> utilizar animações específicas para garantir
            vantagem em ações.
          </>
        ),
      },
      ...
      },
      {
        content: (
          <>
            Não é possível utilizar os comandos "saquear" e "roubar" na cidade.
            A ideia é que os itens sejam recuperados através da reanimação pelos
            membros do <b>Centro Médico Zero</b>.
          </>
        ),
      },
      {
      ...
      },
      {
        content: (
          <>
            Aliança e/ou parceria entre facções/organizações ilegais{" "}
            <b>não são permitidas</b>.
          </>
        ),
      },
      {
        content: (
          <>
            Fica estabelecido que ao sair de qualquer organização seja ela legal
            ou ilegal, o jogador ficará 7 dias sem poder fazer parte de outra
            organização.
          </>
        ),
      },
